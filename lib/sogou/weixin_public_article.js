...
var F = KG.Class.define('WeixinPublicArticle', {
    ...
    getRandomCookie : async function(){
        ...
        var str = 'ABTEST=0|1452140239|v1; weixinIndexVisited=1; SUID=0A2594AF05C60D0A00000000568DEC6E; SUV=00F41B40AF94250A568DEC6E46383707; CXID=F7559F89855650BBF6FEB5D2A29546FA; ad=cYcAIkllll2Q0KNTlllllVz2dTtlllllriyOjkllll9lllllxTDll5@@@@@@@@@@; SNUID=561214A20D082452C290377E0EC20132; sct=6; IPLOC=CN1300; LSTMV=1183%2C455; LCLKINT=30699';
    ...
    getArticleListById : async function(id){
        if(!this.id) this.id = id;

        var ext = await this.getExt();
        console.log(ext);
